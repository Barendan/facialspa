...
function Hero() {
  return (
    <div id="heroSection" className="bg-[#DDDAD2]">
      ...
      <div className="flex flex-col md:flex-row md:items-center lg:mx-auto overflow-hidden h-[95vh] bg-cover bg-no-repeat max-w-[1000px]">
        ...
        <div className="header-container text-[#2E4630] z-10 flex flex-col pt-5 mx-5 md:pt-0 md:pr-5">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <h2 className="text-[#2E4630] text-[4.1vw] sm:text-[3.4vw] md:text-[20px] px-5">
          ...
          {/* CTA Buttons */}
          <div className="w-[100%] flex flex-row justify-around text-white pt-5">
