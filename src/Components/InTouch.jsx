...
function InTouch() {
  ...
  return (
    <>
      <div  id="inTouchSection" className="flex justify-center items-center py-40 px-4 sm:px-6 md:px-8 lg:px-24">
        <div className="absolute flex justify-between w-full mt-[-1431px] lg:mt-[-714px]">
          <img className="opacity-[0.9]" src={bg1} alt="_bg" />
          <img
            className="hidden sm:block opacity-[0.3] z-[-1]"
            src={bg3}
            alt="_bg"
          />
        </div>
        <div className="flex flex-col relative w-[90%]">
          <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-[70%] bg-[#EDEBE4] rounded-[20px] lg:rounded-tr-[0px] lg:rounded-br-[0px] flex flex-col gap-16 p-20 lg:pr-[200px] xl:pr-[300px]">
