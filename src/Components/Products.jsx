...
function Products() {
  ...
  return (
    <>
      <div id="productsSection" className="px-4 sm:px-6 md:px-8 lg:px-24 py-40 flex justify-center items-center bg-[#DDDAD2] mt-32">
        ...
        <div className="flex flex-col xl:flex-row rounded-[20px] w-full z-[1]">
          ...
          >
            ...
            <button className="w-fit flex text-lg font-quicksand leading-normal bg-white text-[#2E4630] rounded-tl-[30px] rounded-br-[30px] py-4 px-6">
              View Our Store
            </button>
          ...
          <div
            className="xl:rounded-tr-[20px] rounded-bl-[20px] xl:rounded-bl-[0px] rounded-br-[20px] w-full xl:w-[70%] 2xl:w-[65%] bg-[#EDEBE4] flex flex-col lg:flex-row gap-12 lg:gap-4 py-20 xl:py-0 px-12 justify-center items-center bg-no-repeat bg-cover"
            style={{ backgroundImage: `url(${productBg2})` }}
          >
            {products.map((item, index) => (
              <div
                key={index}
                className={`h-fit flex flex-col gap-6 p-4 rounded-[16px] border border-[#CFC4C0] ${
